...
path('lines/<pk>/delete/',views.DeleteLineView.as_view(success_url="/lines"),name='delete_line'),
...
path('stations/<pk>/delete/',views.DeleteStationView.as_view(success_url="/stations/"),name='delete_station'),
...
path('stop/<pk>/delete/',views.DeleteStopView.as_view(success_url="/stops/"),name='delete_stop'),
